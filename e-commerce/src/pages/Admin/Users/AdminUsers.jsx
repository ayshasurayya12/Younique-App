                                ...
                                {getPageNumbers().map((page, index) =>
                                    page === "..." ? (
                                        ...
                                        <button
                                            ...
                                            className={`w-9 h-9 rounded-lg font-medium transition text-sm ${currentPage === page ? "bg-[#B37869] text-white shadow-md" : "border border-gray-300 text-gray-600 hover:bg-gray-50"}`}
                                        >
                                            {page}
                                        </button>
                                    )
